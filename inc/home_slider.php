					...
					<div class="tp-banner">
						<ul>
							 <li data-transition="fade" data-slotamount="7">
								...
								data-endspeed="500"
								data-endeasing="Power4.easeIn"></div>
								<div class="caption lfl large-text tp-resizeme witTxt" style="text-transform: uppercase" data-x="450" data-y="200" data-speed="600" data-start="2500" data-easing="Power4.easeOut"
											data-splitin="chars"
											data-splitout="chars"
								...
								<div class="caption lfl large-title tp-resizeme witTxt" style="font-size:40px" data-x="450" data-y="240" data-speed="600" data-start="2800" data-easing="Power4.easeOut"
											...
											data-endeasing="Power1.easeOut"
								>Business</div>
								<div class="caption lfl large-text tp-resizeme witTxt" style="text-transform: uppercase" data-x="450" data-y="310" data-speed="600" data-start="3100" data-easing="Power4.easeOut"
											data-splitin="chars"
											data-splitout="chars"
											data-elementdelay="0.05"
											data-endelementdelay="0.05"
...
><i class="fa fa-anchor main-bg" style="border:5px #fff solid;padding:30px;font-size:60px;line-height:45px;border-radius:50%"></i></div>
								<div class="caption lfr large-title tp-resizeme main-color" style="font-size:40px" data-x="right" data-y="140" data-speed="800" data-start="2800"><span style="font-weight:100 !important;color:#fff">We </span>SAIF POWERTEC LTD</div>
								...
								Saif Software Development <br>
								Team is a group of Experts <br>
								in Software Development, <br>
								 SEO, Graphic Design and<br>
